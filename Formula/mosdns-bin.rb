class MosdnsBin < Formula
  ...
  sha256 "3386d58cdab1b5debc14da4b25ad44ee352b5203a9426377fa364affd4041578"

  head do
    url "https://github.com/IrineSistiana/mosdns/releases/download/v1.5.0/mosdns-darwin-amd64.zip"
    # sha256 ""
  end
