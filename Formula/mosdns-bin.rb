class MosdnsBin < Formula
  ...
  sha256 "f3a935a4f02844d98b29a1015dfd34f73262778cc1174a1d8f3f280ce0af4d7f"

  head do
    url "https://github.com/IrineSistiana/mosdns/releases/download/v1.5.1/mosdns-darwin-amd64.zip"
    # sha256 ""
  end
